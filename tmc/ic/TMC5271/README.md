...
1. Include all the files of the TMC-API/ic/tmc/TMC5271 folder into the custom project.
2. Include the TMC5271.h file in the custom source code.
...
To communicate with TMC5271 IC, the TMC-API library needs to know which bus (UART, SPI) it shall use. For that, the callback function **'tmc5271_getBusType()'** needs to be implemented.

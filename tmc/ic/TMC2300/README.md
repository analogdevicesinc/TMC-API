...
To communicate with TMC2300 IC, the TMC-API library needs to know which bus UART it shall use. For that, the callback function **'tmc2300_getBusType()'** needs to be implemented.

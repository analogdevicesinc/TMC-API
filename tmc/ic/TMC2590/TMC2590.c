...
#include "../TMC2590/TMC2590.h"

// => SPI wrapper
extern void tmc2590_readWriteArray(uint8 channel, uint8 *data, size_t length);
// <= SPI wrapper

static void continousSync(TMC2590TypeDef *tmc2590);
static void readWrite(TMC2590TypeDef *tmc2590, uint32 value);
static void readImmediately(TMC2590TypeDef *tmc2590, uint8 rdsel);
...
void tmc2590_writeConfiguration(TMC2590TypeDef *tmc2590, ConfigurationTypeDef *TMC2590_config)
{
	...
	//uint8 *ptr = &TMC2590_config->configIndex;
	//const int32 *settings = (TMC2590_config->state == CONFIG_RESTORE) ? TMC2590_config->shadowRegister : tmc2590->registerResetState;
